...
* participant[automaticTransmission].extension contains KIOLAParticipantDeviceDefinition named participantDeviceDefinition 1..1 MS
...
* participant[manualEntry].extension contains KIOLAParticipantDeviceDefinition named participantDeviceDefinition 1..1 MS
